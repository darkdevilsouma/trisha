...
jalan("\033[1;97m•◈•───────•◈ WELCOME TO THIS DARK WORLD •◈•───────•◈•")  
...
jalan("   \033[1;91m LOVE YOU INDIA ")	
jalan("   \033[1;91m BY TRISHA ")	

jalan("   \033[1;93m Welcome to trisha's world ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mTRISHA\033[1;96m•◈•──────────•◈•")

CorrectUsername = "souma"
CorrectPassword = "trisha"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + TRISHA
            loop = 'false'
        else:
            print "Wrong Password"
            os.system('xdg-open https://www.youtube.com/c/MouliArt')
    else:
        print "Wrong Username"
        os.system('xdg-open https://www.youtube.com/channel/UCbG57fI6cm0PEztwi_eNSDA')
...
def menu():
	...
	print "   \033[1;36;40m      ╚═════════════════════════════════╝"
	print "\033[1;32;40m[1] \033[1;33;40m══Start fast cloning"	
	print "\033[1;32;40m[2] \033[1;33;40m══Update TRISHA"																														
